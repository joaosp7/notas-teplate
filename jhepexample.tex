...
\usepackage[brazilian]{babel}  % precisa alterar se for escrever em ingles
\usepackage{kpfonts} % isso aq é essa fonte ai bonitona no documento, se quiser sem; só apagar.
...
\emailAdd{joaolucas.rodrigues@usp.br}
